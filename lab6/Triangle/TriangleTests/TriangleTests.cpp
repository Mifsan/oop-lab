...
{
	ExpectConstructorFailure<invalid_argument>(-1, 2, 3, "Argument must not be negative\n");
	ExpectConstructorFailure<invalid_argument>(1, -2, 3, "Argument must not be negative\n");
...
{
	ExpectConstructorFailure<domain_error>(4, 1, 2, "One of the sides of the triangle is larger than the sum of the other two sides\n");
	ExpectConstructorFailure<domain_error>(1, 4, 2, "One of the sides of the triangle is larger than the sum of the other two sides\n");
	ExpectConstructorFailure<domain_error>(1, 2, 4, "One of the sides of the triangle is larger than the sum of the other two sides\n");
}
